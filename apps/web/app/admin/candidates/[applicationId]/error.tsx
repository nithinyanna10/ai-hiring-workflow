...
export default function AdminCandidateDetailError({
  reset,
}: {
  error: Error;
  reset: () => void;
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-16">
      <div className="rounded-lg border border-red-200 bg-white p-8">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight">Unable to load application</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          The candidate detail page could not be loaded right now. Try again.
        </p>
        <button
          type="button"
          onClick={reset}
